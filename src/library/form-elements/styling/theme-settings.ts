...
export const baseTheme: ThemeStyling = {
  ...
  'social-textarea': {
    ...
    label: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1',
    textarea: 'block  text-sm w-full p-2 dark:bg-gray-700 dark:text-white',
    description: 'mt-1 text-xs text-gray-500 dark:text-gray-400',
    error: 'mt-1 text-xs text-red-500 dark:text-red-400',
    icon: 'h-5 w-5 text-gray-400 dark:text-gray-500',
  ...
  text: {
    ...
    label: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1',
    input:
      'block w-full text-sm rounded-md border-gray-300 dark:border-gray-600 border shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 px-2 py-1 focus:ring-indigo-500 dark:focus:ring-indigo-400 sm:text-sm dark:bg-gray-700 dark:text-white',
    description: 'mt-1 text-xs text-gray-500 dark:text-gray-400',
    error: 'mt-1 text-xs text-red-500 dark:text-red-400',
    icon: 'h-5 w-5 text-gray-400 dark:text-gray-500',
    iconContainer: 'absolute inset-y-0 right-0 flex items-center pr-3',
  ...
  number: {
    ...
    label: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1',
    input:
      'block w-full text-sm rounded-md border-gray-300 dark:border-gray-600 shadow-sm border py-1 px-2 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 sm:text-sm dark:bg-gray-700 dark:text-white',
    description: 'mt-1 text-xs text-gray-500 dark:text-gray-400',
    error: 'mt-1 text-xs text-red-500 dark:text-red-400',
    prefix: 'flex select-none items-center pl-3 text-gray-500 dark:text-gray-400 sm:text-sm',
    suffix: 'flex select-none items-center pr-3 text-gray-500 dark:text-gray-400 sm:text-sm',
  ...
  textarea: {
    ...
    label: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1',
    textarea:
      'block w-full  text-sm rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 sm:text-sm dark:bg-gray-700 dark:text-white',
    description: 'mt-1 text-xs text-gray-500 dark:text-gray-400',
    error: 'mt-1 text-xs text-red-500 dark:text-red-400',
  },
  // Date range styling
  ...
  listbox: {
    container: 'relative w-full',
    button:
      'relative w-full cursor-default rounded bg-white dark:bg-gray-700 pl-2 py-1 pr-8 text-left text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 sm:text-sm',
    options: 'mt-1 max-h-96 min-w-48 overflow-auto rounded bg-white dark:bg-gray-700 py-1 text-base shadow-lg ring-1 ring-black dark:ring-gray-600 ring-opacity-5 focus:outline-none sm:text-sm',
    option: 'relative cursor-default select-none py-1 pl-2 pr-9',
  ...
  switch: {
    ...
    track:
      'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 dark:focus:ring-indigo-400 focus:ring-offset-2',
  ...
  array: {
    ...
    addButton:
      'mt-2 inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-indigo-400',
...
export const primaryTheme: ThemeStyling = {
  ...
  array: {
    addButton:
      'mt-2 inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-blue-400',
  },
};
...
export const secondaryTheme: ThemeStyling = {
  ...
  array: {
    addButton:
      'mt-2 inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-green-400',
  },
};
...
export const mintflowTheme: ThemeStyling = {
  ...
  control: {
    container: 'rounded-lg mx-auto mt-0 ',
  },
  'control-group': {
    container: 'justify-start gap-3',
  },
...
export const minimalTheme: ThemeStyling = {
  ...
  switch: {
    ...
    track:
      'relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-1 focus:ring-gray-400 dark:focus:ring-gray-500 focus:ring-offset-1',
  ...
  array: {
    ...
    addButton:
      'mt-1 inline-flex items-center px-2 py-1 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-gray-500 hover:bg-gray-600 dark:bg-gray-600 dark:hover:bg-gray-500 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-gray-400 dark:focus:ring-gray-500',
    removeButton: 'absolute top-1 right-1 text-gray-300 hover:text-gray-400 dark:text-gray-600 dark:hover:text-gray-500',
  },
};

export const inlineTheme: ThemeStyling = {
  // Layout components
  ' appmint-form': {
    root: 'p-0 m-0',
  },
