...
export const baseTheme: ThemeStyling = {
    ...
    text: {
        ...
        'container-array': 'relative my-0 w-full',
        label: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1',
        input: 'block w-full text-sm rounded-md border-gray-300 dark:border-gray-600 border shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 px-2 py-1 focus:ring-indigo-500 dark:focus:ring-indigo-400 sm:text-sm dark:bg-gray-700 dark:text-white',
        description: 'mt-1 text-xs text-gray-500 dark:text-gray-400',
        error: 'mt-1 text-xs text-red-500 dark:text-red-400',
        icon: 'h-5 w-5 text-gray-400 dark:text-gray-500',
        iconContainer: 'absolute inset-y-0 right-0 flex items-center pr-3',
    ...
    number: {
        ...
        'container-array': 'relative my-0 w-full',
        label: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1',
        input: 'block w-full text-sm rounded-md border-gray-300 dark:border-gray-600 shadow-sm border py-1 px-2 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 sm:text-sm dark:bg-gray-700 dark:text-white',
        description: 'mt-1 text-xs text-gray-500 dark:text-gray-400',
        error: 'mt-1 text-xs text-red-500 dark:text-red-400',
        prefix: 'flex select-none items-center pl-3 text-gray-500 dark:text-gray-400 sm:text-sm',
        suffix: 'flex select-none items-center pr-3 text-gray-500 dark:text-gray-400 sm:text-sm',
    ...
    'number-range': {
        container: 'relative my-2  w-full',
        label: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1',
        maxInput: 'block w-full  text-sm rounded-md border-gray-300 dark:border-gray-600 shadow-sm border py-1 px-2 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 sm:text-sm dark:bg-gray-700 dark:text-white',
        minInput: 'block w-full  text-sm rounded-md border-gray-300 dark:border-gray-600 shadow-sm border py-1 px-2 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 sm:text-sm dark:bg-gray-700 dark:text-white',
        description: 'mt-1 text-xs text-gray-500 dark:text-gray-400',
        error: 'mt-1 text-xs text-red-500 dark:text-red-400',
        prefix: 'flex select-none items-center pl-3 text-gray-500 dark:text-gray-400 sm:text-sm',
        suffix: 'flex select-none items-center pr-3 text-gray-500 dark:text-gray-400 sm:text-sm',
    ...
    textarea: {
        container: 'relative my-2  w-full',
        label: 'block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1',
        textarea: 'block w-full  text-sm rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 sm:text-sm dark:bg-gray-700 dark:text-white',
        description: 'mt-1 text-xs text-gray-500 dark:text-gray-400',
        error: 'mt-1 text-xs text-red-500 dark:text-red-400',
    },
    // Date range styling
